...
namespace KRG {
    ...
    public class TransformInspector : Editor {
        ...
        protected static GUIContent positionGUIContent = new GUIContent(LocalString("Position")
        , LocalString("The local position of this Game Object relative to the parent."));
        protected static GUIContent rotationGUIContent = new GUIContent(LocalString("Rotation")
        , LocalString("The local rotation of this Game Object relative to the parent."));
        protected static GUIContent scaleGUIContent = new GUIContent(LocalString("Scale")
